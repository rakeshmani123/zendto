<?php /* Smarty version Smarty-3.0.8, created on 2015-09-19 06:40:44
         compiled from "/home/antriksh/public_html/Zend/templates/about.tpl" */ ?>
<?php /*%%SmartyHeaderCode:101606721655fd3bacb821f4-03188418%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '90edc6121454eb18e67ff9b198517082fbad766b' => 
    array (
      0 => '/home/antriksh/public_html/Zend/templates/about.tpl',
      1 => 1313131594,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '101606721655fd3bacb821f4-03188418',
  'function' => 
  array (
  ),
...
<h4>About the <?php echo $_smarty_tpl->getConfigVariable('ServiceTitle');?>
 Service...</h4>
...
<?php echo $_smarty_tpl->getConfigVariable('ServiceTitle');?>
 to temporarily make a file (or files) available to
...
<?php echo $_smarty_tpl->getConfigVariable('ServiceTitle');?>
 system:  <i>inside</i> users, who are associated
with <?php echo $_smarty_tpl->getConfigVariable('OrganizationType');?>
 running the service, and <i>outside</i> users,
...
<div style="border:1px solid #C0C0C0;background:#E0E0E0;margin:12px;padding:4px;">
  <b><i>drop-off</i></b>:  one or more files uploaded to the <?php echo $_smarty_tpl->getConfigVariable('ServiceTitle');?>
 as a single item for delivery to a person or people
</div>
...
The recipient has <?php echo $_smarty_tpl->getVariable('keepForDays')->value;?>
 days to pick-up the files.  Each night, drop-offs that are older than <?php echo $_smarty_tpl->getVariable('keepForDays')->value;?>
 days are removed from the system.<br/>
<br/>
</blockquote>
...
PDF that a student uploaded to <?php echo $_smarty_tpl->getConfigVariable('ServiceTitle');?>
 for you.
...
<br/>
<?php echo $_smarty_tpl->getConfigVariable('ServiceTitle');?>
 features support for the server-side components
...
The <?php echo $_smarty_tpl->getConfigVariable('ServiceTitle');?>
 software itself has limits on the amount of
...
<?php echo $_smarty_tpl->getVariable('maxFileSize')->value;?>
 per file, or <?php echo $_smarty_tpl->getVariable('maxDropoffSize')->value;?>
 total for the entire dropoff.<br/>
<br/>
...
Doke Scott.  Version <?php echo $_smarty_tpl->getVariable('ztVersion')->value;?>
