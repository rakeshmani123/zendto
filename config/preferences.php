...
$NSSDROPBOX_PREFS = array(
  ...
  'SQLiteDatabase'       => NSSDROPBOX_DATA_DIR."antriksh_zend.sqlite",

  // Next 4 lines needed for MySQL operation
  'MySQLhost'            => 'localhost',
  'MySQLuser'            => 'antriksh_zend1',
  'MySQLpassword'        => 'ashu@1212',
  'MySQLdb'              => 'antriksh_zend',
  ...
  'recaptchaPublicKey'   => '6LfjKA4TAAAAAJmVDB3H_TvHvQ1ivtFjc5HWdxp4',
  'recaptchaPrivateKey'  => '6LfjKA4TAAAAAG-5RzAbG-BMzQybHndLFZaU6IEj',
...
var_dump(NSSDROPBOX_LIB_DIR.SqlBackend.'.php');
echo "asdfghjk";
